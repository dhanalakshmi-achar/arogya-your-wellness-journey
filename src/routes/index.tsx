  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Track nutrition, fitness, sleep, mood and women's health in one beautifully simple app.",
      },
      {
        property: "og:title",
        content: "Arogya — Holistic health, made joyful",
      },
      {
        property: "og:description",
        content:
          "One app for body, mind, and cycle — guided by an AI coach that actually helps.",
      },
    ],
  }),
...
function Landing() {
  ...
  Arogya
        ...
        <div className="flex items-center gap-3">
          <Link
            to="/auth"
            className="rounded-full px-4 py-2 text-sm font-semibold transition-opacity hover:opacity-70"
          >
            Sign in
          </Link>
      ...
      <section className="mx-auto max-w-6xl px-5 pb-20 pt-2 sm:pt-4">
        <div className="grid items-center gap-10 md:grid-cols-2">
          {/* LEFT SIDE */}
          <motion.div
            initial={{
          ...
          >
            ...
            {/* DESCRIPTION */}
            <p className="mt-4 max-w-lg text-base text-muted-foreground sm:text-lg">
              Arogya blends nutrition, fitness, sleep,
              mental wellness and women's health into one
              warm, beautiful place — guided by an AI coach
              that actually helps you show up.
            </p>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <Link
                to="/auth"
                className="inline-flex items-center gap-2 rounded-full border bg-card px-6 py-3 text-sm font-semibold shadow-soft"
              >
                I already have an account
              </Link>
            </div>
            ...
            <div className="relative mx-auto max-w-md">
              ...
              <div className="rounded-[2rem] border bg-card p-6 shadow-glow">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {/* Simple sparkle icon instead of second logo */}
                  <div className="grid h-12 w-12 place-items-center rounded-2xl gradient-hero text-white">
        ...
        <div className="mt-24">
          <div className="text-center">
            ...
            <h2 className="mt-2 font-heading text-3xl font-bold tracking-tight sm:text-4xl">
              Everything your body & mind need.
            </h2>
          </div>
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{
                      background: `color-mix(in oklab, ${pillar.tint} 18%, transparent)`,
                      color: pillar.tint,
                    }}
                  >
      ...
      <footer className="border-t">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-2 px-5 py-6 text-xs text-muted-foreground sm:flex-row">
          <div>
            © {new Date().getFullYear()} Arogya. Made with care.
          </div>

          <div>
            Not a medical device. Consult a professional for advice.
          </div>
        </div>
      </footer>
    </div>
